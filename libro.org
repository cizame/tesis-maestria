...
*** Aplicación en algoritmos
    ...
    la convencion de que una unidad de tiempo es igual a un paso
    ejecutado en el algoritmo; es decir si el algoritmo realiza tres
    pasos entonces el tiempo de ejecucion es igual a tres. 

    Imaginemos un ecenario en el que tenemos una lista desordenada de \(n\)
...
**** Algotirmo para encontrar el número mayor de una lista
     
     - Entrada: Lista de \(n\) números.
     - Proceso: 
       - Toma el primero de la lista.
       - Comparalo con el siguiente y quedate con el mayor.
...
****     
     ...
     la respuesta correcta y dos, otimaza el tiempo de ejecución.

***** Termina con la respuesta correcta. 
      
***** Optimiza el tiempo de ejecución.

     Tiempo de ejecución del algoritmo para encontrar el número mayor
     de una lista
