...
***** Termina con la respuesta correcta. 
      ...
      \(i\). Al llegar a este momento el número que teníamos va a ser
      cambiado por el de la posición \(i\) pues por hipótesis ahí se
      encuentra el mayor.

      Sin embargo el algoritmo no necesariamente termina en este
      momento, pues puede que aún haya más números en la lista que no
      han sido comparadas. En cada comparación siguiente el número que
...
**** 
     Demostración de porque es óptimo
